    ...
    <div className="flex flex-col gap-4 py-6 px-4">
      ...
      <div className="relative">
        <motion.div
          ...
          className="grid grid-cols-7 gap-2 min-h-[160px]"
        >
              ...
              <div key={idx} className="relative">
                {card ? (
                  <motion.div
                    ...
                    className={isValidTarget ? "cursor-crosshair" : ""}
                  >
                    <Card
                      {...card}
                      type="minion"
                  ...
                  <div className="w-full h-full border-2 border-dashed border-gray-600/30 rounded-xl" />
                )}
              </div>
            );
          })}
      ...
      {/* Center Divider */}
      <div className="relative h-1 bg-gradient-to-r from-transparent via-yellow-500/50 to-transparent">
                    ...
                    >
                      ...
                      {card.canAttack && (
                        <motion.div
                          ...
                          className="absolute inset-0 border-3 border-green-400 rounded-xl pointer-events-none"
                        />
                      )}
                    </motion.div>
                  )}
